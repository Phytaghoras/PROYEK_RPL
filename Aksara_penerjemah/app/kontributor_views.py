...
# 1) Daftar Kalimat
# ----------------------
@kontributor_bp.route('/daftar_kalimat', methods=['GET', 'POST'])
@login_required
def daftar_kalimat():
    if request.method == 'POST':
        ...
        return redirect(url_for('kontributor.daftar_kalimat'))
    ...
    return render_template(
        'kontributor/Daftar_kalimat.html',
        varians=varians,
...
# 2) Edit Kalimat
# ----------------------
@kontributor_bp.route('/edit_kalimat/<int:id_kelompok>', methods=['POST'])
...
# 3) Hapus Kalimat
# ----------------------
@kontributor_bp.route('/hapus_kalimat/<int:id_kalimat>', methods=['POST'])
...
# 4) Pencarian Kalimat
# ----------------------
@kontributor_bp.route('/cari_kalimat', methods=['GET'])
@login_required
def cari_kalimat():
...
# ----------------------
@kontributor_bp.route('/detail_kalimat_data/<int:id_kelompok>', methods=['GET'])
@login_required
...
# ----------------------
@kontributor_bp.route('/export_kalimat/csv', methods=['GET'])
...
# ----------------------
@kontributor_bp.route('/import_kalimat/csv', methods=['POST'])
...
# ----------------------
@kontributor_bp.route('/hapus_terpilih_kalimat', methods=['POST'])
@login_required
...
@kontributor_bp.route('/Daftar_kata', methods=['GET', 'POST'])
@login_required
def daftarkata():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('kontributor.daftarkata'))
...
@kontributor_bp.route('/cari_kata', methods=['GET'])
@login_required
def cari_kata():
    """
...
@kontributor_bp.route('/detail_kata_data/<int:id_kelompok>', methods=['GET'])
@login_required
...
@kontributor_bp.route('/edit_kata/<int:id_kelompok>', methods=['POST'])
...
@kontributor_bp.route('/hapus_kata/<int:id_kata>', methods=['POST'])
...
@kontributor_bp.route('/export/csv', methods=['GET'])
def export_csv():
...
@kontributor_bp.route('/import/csv', methods=['POST'])
def import_csv():
    if 'file' not in request.files:
        return jsonify({'status': 'error', 'message': 'Tidak ada file yang diunggah.'}), 400
...
@kontributor_bp.route('/import/csv/confirm', methods=['POST'])
...
@kontributor_bp.route('/hapus_terpilih', methods=['POST'])
@login_required
def hapus_terpilih():
    """
